...
namespace Language_fr_na {
  ...
  PROGMEM Language_Str LANGUAGE                            = _UxGT("Francais");

  PROGMEM Language_Str WELCOME_MSG                         = MACHINE_NAME _UxGT(" prete.");
  ...
  PROGMEM Language_Str MSG_MEDIA_INSERTED                  = _UxGT("Media insere");
  PROGMEM Language_Str MSG_MEDIA_REMOVED                   = _UxGT("Media retire");
  PROGMEM Language_Str MSG_MEDIA_WAITING                   = _UxGT("Attente media");
  PROGMEM Language_Str MSG_MEDIA_READ_ERROR                = _UxGT("Err lecture media");
  PROGMEM Language_Str MSG_MEDIA_USB_REMOVED               = _UxGT("USB debranche");
  PROGMEM Language_Str MSG_MEDIA_USB_FAILED                = _UxGT("Erreur media USB");
  PROGMEM Language_Str MSG_LCD_ENDSTOPS                    = _UxGT("Butees");
  PROGMEM Language_Str MSG_LCD_SOFT_ENDSTOPS               = _UxGT("Butees SW");
  PROGMEM Language_Str MSG_MAIN                            = _UxGT("Menu principal");
  PROGMEM Language_Str MSG_ADVANCED_SETTINGS               = _UxGT("Config. avancee");
  PROGMEM Language_Str MSG_CONFIGURATION                   = _UxGT("Configuration");
  PROGMEM Language_Str MSG_AUTOSTART                       = _UxGT("Exec. auto.gcode");
  PROGMEM Language_Str MSG_DISABLE_STEPPERS                = _UxGT("Arreter moteurs");
  ...
  PROGMEM Language_Str MSG_LEVEL_BED_DONE                  = _UxGT("Mise a niveau OK!");
  PROGMEM Language_Str MSG_Z_FADE_HEIGHT                   = _UxGT("Hauteur lissee");
  PROGMEM Language_Str MSG_SET_HOME_OFFSETS                = _UxGT("Regl. decal origine");
  PROGMEM Language_Str MSG_HOME_OFFSETS_APPLIED            = _UxGT("Decalages appliques");
  PROGMEM Language_Str MSG_SET_ORIGIN                      = _UxGT("Regler origine");
  #if PREHEAT_COUNT
    PROGMEM Language_Str MSG_PREHEAT_1                     = _UxGT("Prechauffage ") PREHEAT_1_LABEL;
    PROGMEM Language_Str MSG_PREHEAT_1_H                   = _UxGT("Prechauffage ") PREHEAT_1_LABEL " ~";
    PROGMEM Language_Str MSG_PREHEAT_1_END                 = _UxGT("Prech. ") PREHEAT_1_LABEL _UxGT(" buse");
    PROGMEM Language_Str MSG_PREHEAT_1_END_E               = _UxGT("Prech. ") PREHEAT_1_LABEL _UxGT(" buse ~");
    PROGMEM Language_Str MSG_PREHEAT_1_ALL                 = _UxGT("Prech. ") PREHEAT_1_LABEL _UxGT(" Tout");
    PROGMEM Language_Str MSG_PREHEAT_1_BEDONLY             = _UxGT("Prech. ") PREHEAT_1_LABEL _UxGT(" lit");
    PROGMEM Language_Str MSG_PREHEAT_1_SETTINGS            = _UxGT("Regler prech. ") PREHEAT_1_LABEL;

    PROGMEM Language_Str MSG_PREHEAT_M                     = _UxGT("Prechauffage $");
    PROGMEM Language_Str MSG_PREHEAT_M_H                   = _UxGT("Prechauffage $ ~");
    PROGMEM Language_Str MSG_PREHEAT_M_END                 = _UxGT("Prech. $ buse");
    PROGMEM Language_Str MSG_PREHEAT_M_END_E               = _UxGT("Prech. $ buse ~");
    PROGMEM Language_Str MSG_PREHEAT_M_ALL                 = _UxGT("Prech. $ Tout");
    PROGMEM Language_Str MSG_PREHEAT_M_BEDONLY             = _UxGT("Prech. $ lit");
    PROGMEM Language_Str MSG_PREHEAT_M_SETTINGS            = _UxGT("Regler prech. $");
  #endif
  PROGMEM Language_Str MSG_PREHEAT_CUSTOM                  = _UxGT("Prechauf. perso");
  ...
  PROGMEM Language_Str MSG_RETRACT                         = _UxGT("Retractation");
  PROGMEM Language_Str MSG_MOVE_AXIS                       = _UxGT("Deplacer un axe");
  PROGMEM Language_Str MSG_BED_LEVELING                    = _UxGT("Regler Niv. lit");
  ...
  PROGMEM Language_Str MSG_EDITING_STOPPED                 = _UxGT("Modification arretee");
  ...
  PROGMEM Language_Str MSG_IDEX_MODE_FULL_CTRL             = _UxGT("Controle complet");
  ...
  PROGMEM Language_Str MSG_G26_PRIME_DONE                  = _UxGT("Amorce terminee");
  PROGMEM Language_Str MSG_G26_CANCELED                    = _UxGT("G26 annule");
  ...
  PROGMEM Language_Str MSG_UBL_LEVEL_BED                   = _UxGT("Niveau lit unifie");
  ...
  PROGMEM Language_Str MSG_UBL_BC_REMOVE                   = _UxGT("oter et mesurer lit");
  ...
  PROGMEM Language_Str MSG_UBL_DEACTIVATE_MESH             = _UxGT("Desactiver l'UBL");
  PROGMEM Language_Str MSG_UBL_SET_TEMP_BED                = _UxGT("Temperature lit");
  PROGMEM Language_Str MSG_UBL_BED_TEMP_CUSTOM             = _UxGT("Temperature lit");
  PROGMEM Language_Str MSG_UBL_SET_TEMP_HOTEND             = _UxGT("Temperature buse");
  PROGMEM Language_Str MSG_UBL_HOTEND_TEMP_CUSTOM          = _UxGT("Temperature buse");
  ...
  PROGMEM Language_Str MSG_UBL_FINE_TUNE_MESH              = _UxGT("Reglage fin");
  PROGMEM Language_Str MSG_UBL_DONE_EDITING_MESH           = _UxGT("Terminer");
  PROGMEM Language_Str MSG_UBL_BUILD_MESH_MENU             = _UxGT("Creer la grille");
  #if PREHEAT_COUNT
    PROGMEM Language_Str MSG_UBL_BUILD_MESH_M              = _UxGT("Creer grille $");
    PROGMEM Language_Str MSG_UBL_VALIDATE_MESH_M           = _UxGT("Impr. grille $");
  #endif
  PROGMEM Language_Str MSG_UBL_BUILD_CUSTOM_MESH           = _UxGT("Creer grille ...");
  PROGMEM Language_Str MSG_UBL_BUILD_COLD_MESH             = _UxGT("Mesure a froid");
  ...
  PROGMEM Language_Str MSG_UBL_VALIDATE_MESH_MENU          = _UxGT("Verifier grille");
  ...
  PROGMEM Language_Str MSG_UBL_3POINT_MESH_LEVELING        = _UxGT("Niveau a 3 points");
  ...
  PROGMEM Language_Str MSG_UBL_SIDE_POINTS                 = _UxGT("Points lateraux");
  PROGMEM Language_Str MSG_UBL_MAP_TYPE                    = _UxGT("Type de carte");
  PROGMEM Language_Str MSG_UBL_OUTPUT_MAP                  = _UxGT("Exporter grille");
  PROGMEM Language_Str MSG_UBL_OUTPUT_MAP_HOST             = _UxGT("Export pour hote");
  ...
  PROGMEM Language_Str MSG_UBL_INVALIDATE_CLOSEST          = _UxGT("Effacer le + pres");
  PROGMEM Language_Str MSG_UBL_FINE_TUNE_ALL               = _UxGT("Reglage fin (tous)");
  PROGMEM Language_Str MSG_UBL_FINE_TUNE_CLOSEST           = _UxGT("Reglage fin + pres");
  PROGMEM Language_Str MSG_UBL_STORAGE_MESH_MENU           = _UxGT("Stockage grille");
  PROGMEM Language_Str MSG_UBL_STORAGE_SLOT                = _UxGT("Slot memoire");
  ...
  PROGMEM Language_Str MSG_MESH_LOADED                     = _UxGT("Grille %i chargee");
  PROGMEM Language_Str MSG_MESH_SAVED                      = _UxGT("Grille %i enreg.");
  PROGMEM Language_Str MSG_UBL_NO_STORAGE                  = _UxGT("Pas de memoire");
  ...
  PROGMEM Language_Str MSG_UBL_Z_OFFSET_STOPPED            = _UxGT("Decal. Z arrete");
  PROGMEM Language_Str MSG_UBL_STEP_BY_STEP_MENU           = _UxGT("Assistant UBL");
  PROGMEM Language_Str MSG_UBL_1_BUILD_COLD_MESH           = _UxGT("1.Mesure a froid");
  PROGMEM Language_Str MSG_UBL_2_SMART_FILLIN              = _UxGT("2.Completer auto.");
  PROGMEM Language_Str MSG_UBL_3_VALIDATE_MESH_MENU        = _UxGT("3.Verifier grille");
  PROGMEM Language_Str MSG_UBL_4_FINE_TUNE_ALL             = _UxGT("4.Reglage fin");
  PROGMEM Language_Str MSG_UBL_5_VALIDATE_MESH_MENU        = _UxGT("5.Verifier grille");
  PROGMEM Language_Str MSG_UBL_6_FINE_TUNE_ALL             = _UxGT("6.Reglage fin");
  PROGMEM Language_Str MSG_UBL_7_SAVE_MESH                 = _UxGT("7.Stocker grille");

  PROGMEM Language_Str MSG_LED_CONTROL                     = _UxGT("Controle LED");
  PROGMEM Language_Str MSG_LEDS                            = _UxGT("Lumiere");
  PROGMEM Language_Str MSG_LED_PRESETS                     = _UxGT("Preregl. LED");
  ...
  PROGMEM Language_Str MSG_INTENSITY_R                     = _UxGT("Intensite rouge");
  PROGMEM Language_Str MSG_INTENSITY_G                     = _UxGT("Intensite vert");
  PROGMEM Language_Str MSG_INTENSITY_B                     = _UxGT("Intensite bleu");
  PROGMEM Language_Str MSG_INTENSITY_W                     = _UxGT("Intensite blanc");
  PROGMEM Language_Str MSG_LED_BRIGHTNESS                  = _UxGT("Luminosite");

  PROGMEM Language_Str MSG_MOVING                          = _UxGT("Deplacement...");
  PROGMEM Language_Str MSG_FREE_XY                         = _UxGT("Debloquer XY");
  PROGMEM Language_Str MSG_MOVE_X                          = _UxGT("Deplacer X");
  PROGMEM Language_Str MSG_MOVE_Y                          = _UxGT("Deplacer Y");
  PROGMEM Language_Str MSG_MOVE_Z                          = _UxGT("Deplacer Z");
  ...
  PROGMEM Language_Str MSG_MOVE_Z_DIST                     = _UxGT("Deplacer %smm");
  PROGMEM Language_Str MSG_MOVE_01MM                       = _UxGT("Deplacer 0.1mm");
  PROGMEM Language_Str MSG_MOVE_1MM                        = _UxGT("Deplacer 1mm");
  PROGMEM Language_Str MSG_MOVE_10MM                       = _UxGT("Deplacer 10mm");
  ...
  PROGMEM Language_Str MSG_CONTROL                         = _UxGT("Controler");
  ...
  PROGMEM Language_Str MSG_LCD_OFF                         = _UxGT("Arret");
  PROGMEM Language_Str MSG_PID_AUTOTUNE                    = _UxGT("PID Autotune");
  PROGMEM Language_Str MSG_PID_AUTOTUNE_E                  = _UxGT("PID Autotune *");
  PROGMEM Language_Str MSG_PID_AUTOTUNE_DONE               = _UxGT("Tuning PID termine");
  ...
  PROGMEM Language_Str MSG_PID_TIMEOUT                     = _UxGT("Echec Autotune! Oper. expiree");
  PROGMEM Language_Str MSG_SELECT                          = _UxGT("Selectionner");
  PROGMEM Language_Str MSG_SELECT_E                        = _UxGT("Selectionner *");
  PROGMEM Language_Str MSG_ACC                             = _UxGT("Acceleration");
  PROGMEM Language_Str MSG_JERK                            = _UxGT("Jerk");
  PROGMEM Language_Str MSG_VA_JERK                         = _UxGT("V") LCD_STR_A _UxGT(" jerk");
  PROGMEM Language_Str MSG_VB_JERK                         = _UxGT("V") LCD_STR_B _UxGT(" jerk");
  PROGMEM Language_Str MSG_VC_JERK                         = _UxGT("V") LCD_STR_C _UxGT(" jerk");
  PROGMEM Language_Str MSG_VE_JERK                         = _UxGT("Ve jerk");
  PROGMEM Language_Str MSG_VELOCITY                        = _UxGT("Velocite");
  PROGMEM Language_Str MSG_JUNCTION_DEVIATION              = _UxGT("Deviat. jonct.");
  PROGMEM Language_Str MSG_VTRAV_MIN                       = _UxGT("Vmin course");
  PROGMEM Language_Str MSG_ACCELERATION                    = _UxGT("Acceleration");
  PROGMEM Language_Str MSG_A_RETRACT                       = _UxGT("Acc.retraction");
  PROGMEM Language_Str MSG_A_TRAVEL                        = _UxGT("Acc.course");
  PROGMEM Language_Str MSG_XY_FREQUENCY_LIMIT              = _UxGT("Frequence max");
  ...
  PROGMEM Language_Str MSG_FILAMENT_DIAM                   = _UxGT("Diametre fil.");
  PROGMEM Language_Str MSG_FILAMENT_DIAM_E                 = _UxGT("Diametre fil. *");
  ...
  PROGMEM Language_Str MSG_RESTORE_DEFAULTS                = _UxGT("Restaurer defauts");
  PROGMEM Language_Str MSG_INIT_EEPROM                     = _UxGT("Initialiser EEPROM");
  PROGMEM Language_Str MSG_SETTINGS_STORED                 = _UxGT("Config. enregistree");
  ...
  PROGMEM Language_Str MSG_PREPARE                         = _UxGT("Preparer");
  PROGMEM Language_Str MSG_TUNE                            = _UxGT("Regler");
  PROGMEM Language_Str MSG_START_PRINT                     = _UxGT("Demarrer impression");
  ...
  PROGMEM Language_Str MSG_BUTTON_DONE                     = _UxGT("Termine");
  ...
  PROGMEM Language_Str MSG_STOP_PRINT                      = _UxGT("Arreter impr.");
  ...
  PROGMEM Language_Str MSG_OUTAGE_RECOVERY                 = _UxGT("Recup. coup.");
  PROGMEM Language_Str MSG_MEDIA_MENU                      = _UxGT("Impression SD");
  PROGMEM Language_Str MSG_NO_MEDIA                        = _UxGT("Pas de media");
  ...
  PROGMEM Language_Str MSG_PRINT_ABORTED                   = _UxGT("Impr. annulee");
  PROGMEM Language_Str MSG_NO_MOVE                         = _UxGT("Moteurs bloques");
  PROGMEM Language_Str MSG_KILLED                          = _UxGT("KILLED");
  PROGMEM Language_Str MSG_STOPPED                         = _UxGT("STOPPe");
  PROGMEM Language_Str MSG_CONTROL_RETRACT                 = _UxGT("Retractation mm");
  PROGMEM Language_Str MSG_CONTROL_RETRACT_SWAP            = _UxGT("Ech. retr. mm");
  PROGMEM Language_Str MSG_CONTROL_RETRACTF                = _UxGT("Vit. retract°");
  PROGMEM Language_Str MSG_CONTROL_RETRACT_ZHOP            = _UxGT("Saut Z mm");
  PROGMEM Language_Str MSG_CONTROL_RETRACT_RECOVER         = _UxGT("Ret.reprise mm");
  PROGMEM Language_Str MSG_CONTROL_RETRACT_RECOVER_SWAP    = _UxGT("Ech.reprise mm");
  PROGMEM Language_Str MSG_CONTROL_RETRACT_RECOVERF        = _UxGT("V.ret. reprise");
  PROGMEM Language_Str MSG_CONTROL_RETRACT_RECOVER_SWAPF   = _UxGT("V.ech. reprise");
  PROGMEM Language_Str MSG_AUTORETRACT                     = _UxGT("Retraction auto");
  ...
  PROGMEM Language_Str MSG_SINGLENOZZLE_RETRACT_SPEED      = _UxGT("Vitesse retract°");
  ...
  PROGMEM Language_Str MSG_ATTACH_MEDIA                    = _UxGT("Charger le media");
  PROGMEM Language_Str MSG_CHANGE_MEDIA                    = _UxGT("Actualiser media");
  PROGMEM Language_Str MSG_RELEASE_MEDIA                   = _UxGT("Retirer le media");
  PROGMEM Language_Str MSG_ZPROBE_OUT                      = _UxGT("Sonde Z hors lit");
  PROGMEM Language_Str MSG_SKEW_FACTOR                     = _UxGT("Facteur ecart");
  ...
  PROGMEM Language_Str MSG_BLTOUCH_DEPLOY                  = _UxGT("Deployer");
  ...
  PROGMEM Language_Str MSG_TOUCHMI_ZTEST                   = _UxGT("Test decalage Z");
  PROGMEM Language_Str MSG_TOUCHMI_SAVE                    = _UxGT("Sauvegarde");
  PROGMEM Language_Str MSG_MANUAL_DEPLOY_TOUCHMI           = _UxGT("Deployer TouchMI");
  PROGMEM Language_Str MSG_MANUAL_DEPLOY                   = _UxGT("Deployer Sonde Z");
  ...
  PROGMEM Language_Str MSG_ZPROBE_XOFFSET                  = _UxGT("Decalage X");
  PROGMEM Language_Str MSG_ZPROBE_YOFFSET                  = _UxGT("Decalage Y");
  PROGMEM Language_Str MSG_ZPROBE_ZOFFSET                  = _UxGT("Decalage Z");
  PROGMEM Language_Str MSG_BABYSTEP_TOTAL                  = _UxGT("Total");
  PROGMEM Language_Str MSG_ENDSTOP_ABORT                   = _UxGT("Butee abandon");
  ...
  PROGMEM Language_Str MSG_HALTED                          = _UxGT("IMPR. STOPPeE");
  PROGMEM Language_Str MSG_PLEASE_RESET                    = _UxGT("Redemarrer SVP");
  ...
  PROGMEM Language_Str MSG_DELTA_SETTINGS                  = _UxGT("Reglages Delta");
  ...
  PROGMEM Language_Str MSG_3POINT_LEVELING                 = _UxGT("Niveau a 3 points");
  PROGMEM Language_Str MSG_LINEAR_LEVELING                 = _UxGT("Niveau lineaire");
  PROGMEM Language_Str MSG_BILINEAR_LEVELING               = _UxGT("Niveau bilineaire");
  PROGMEM Language_Str MSG_UBL_LEVELING                    = _UxGT("Niveau lit unifie");
  ...
  PROGMEM Language_Str MSG_CASE_LIGHT                      = _UxGT("Lumiere caisson");
  PROGMEM Language_Str MSG_CASE_LIGHT_BRIGHTNESS           = _UxGT("Luminosite");
  PROGMEM Language_Str MSG_KILL_EXPECTED_PRINTER           = _UxGT("Imprimante incorrecte");
    ...
    PROGMEM Language_Str MSG_INFO_COMPLETED_PRINTS         = _UxGT("Terminees");
  ...
  PROGMEM Language_Str MSG_MMU2_NOT_RESPONDING             = _UxGT("MMU ne repond plus");
  ...
  PROGMEM Language_Str MSG_MMU2_RESET                      = _UxGT("Reinit. MMU");
  PROGMEM Language_Str MSG_MMU2_RESETTING                  = _UxGT("Reinit. MMU...");
  ...
  PROGMEM Language_Str MSG_GRADIENT                        = _UxGT("Degrade");
  PROGMEM Language_Str MSG_FULL_GRADIENT                   = _UxGT("Degrade complet");
  PROGMEM Language_Str MSG_TOGGLE_MIX                      = _UxGT("Toggle mix");
  PROGMEM Language_Str MSG_CYCLE_MIX                       = _UxGT("Cycle mix");
  PROGMEM Language_Str MSG_GRADIENT_MIX                    = _UxGT("Mix degrade");
  PROGMEM Language_Str MSG_REVERSE_GRADIENT                = _UxGT("Inverser degrade");
  PROGMEM Language_Str MSG_ACTIVE_VTOOL                    = _UxGT("Active V-tool");
  PROGMEM Language_Str MSG_START_VTOOL                     = _UxGT("Debut V-tool");
  PROGMEM Language_Str MSG_END_VTOOL                       = _UxGT("  Fin V-tool");
  PROGMEM Language_Str MSG_GRADIENT_ALIAS                  = _UxGT("Alias V-tool");
  PROGMEM Language_Str MSG_RESET_VTOOLS                    = _UxGT("Reinit. V-tools");
  PROGMEM Language_Str MSG_COMMIT_VTOOL                    = _UxGT("Valider Mix V-tool");
  PROGMEM Language_Str MSG_VTOOLS_RESET                    = _UxGT("V-tools reinit. ok");
  PROGMEM Language_Str MSG_START_Z                         = _UxGT("Debut Z:");
  ...
  PROGMEM Language_Str MSG_BAD_PAGE_SPEED                  = _UxGT("Erreur vitesse page");
    ...
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_INIT          = _UxGT(MSG_2_LINE("Attente filament", "pour demarrer"));
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_INSERT        = _UxGT(MSG_3_LINE("Inserer filament", "et app. bouton", "pour continuer..."));
    ...
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_INSERT        = _UxGT(MSG_1_LINE("Inserer fil."));
  ...
  PROGMEM Language_Str MSG_TMC_STEPPING_MODE               = _UxGT("Mode pas a pas");
  PROGMEM Language_Str MSG_TMC_STEALTH_ENABLED             = _UxGT("StealthChop active");
  PROGMEM Language_Str MSG_SERVICE_RESET                   = _UxGT("Reinit.");
