...
#define STRING_CONFIG_H_AUTHOR "(Guizz27, LK4pro Bltouch)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_LGT  //  For Alphawise and Longer U30 pro LK4 pro with LGT motherboard
#endif
