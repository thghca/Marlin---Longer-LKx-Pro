...
#define STRING_CONFIG_H_AUTHOR "(DaGr70, LK4pro Bltouch RGB)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 98.58 } // for LK4 pro
...
#define FILAMENT_RUNOUT_SENSOR   //  had a filament runout sensor
  ...
  #define FILAMENT_RUNOUT_SCRIPT "M600" // "M25" // "M600"  -> For Alphawise and Longer U30 pro LK4 pro
 ...
 */
#define LCD_LANGUAGE fr_na  //french without accend for DGUS DWIN screen compatibilities
